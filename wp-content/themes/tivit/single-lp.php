...
<div class="dark-bg">
    <? if(get_field('exibir_intro_lp') == 1){ ?>
        <div id="intro-unfolding" class="mt-0">
            <div class="container">
...
<? if(get_field('exibir_carousel_01_lp') == 1){ ?>
...
<? } ?>
 ...
 <!-- Bloco Carrossel Infinito -->
<? if(get_field('exibir_carousel_02_lp') == 1){ ?>
...
<!-- Depoimentos -->
<? if(get_field('exibir_depoimentos_lp') == 1){ ?>
    ...
    <div id="pecDepoimentos" class="lp-tbanks-depoimentos mx-custom">
      <div id="recipeCarousel2" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?
                if( have_rows('depoimentos_lp') ):
                // Loop through rows.
                    for($i=0; have_rows('depoimentos_lp'); $i++) : the_row();
                    $foto[$i] = get_sub_field('foto');
                    $nome[$i] = get_sub_field('nome');
                    $funcao[$i] = get_sub_field('funcao');
                    $texto[$i] = get_sub_field('texto');
            ?>
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#recipeCarousel2" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#recipeCarousel2" data-bs-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
