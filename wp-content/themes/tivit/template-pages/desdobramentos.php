      ...
      <div class="row">
        <div class="col-12">
          <div class="position-relative zindex">
            <h1>soluções POR INDÚSTRIA</h1>
            <h2 class="hide-mobile">MEIOS DE PAGAMENTO</h2>
    ...
    <div id="intro-unfolding">
        <div class="container">
            <div class="d-flex justify-content-center align-items-center w-100">
                <div class="text">
                    <h2>
                        Como a TIVIT entende a complexidade desse desafio ou o cenário atual dessa indústria?
                    </h2>
                </div>
            </div>
        </div>
