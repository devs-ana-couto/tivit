                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="nav nav-tabs " id="myTab" role="tablist">
                                <li class="nav-item inicial mb-3" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active pt-5" id="home" role="tabpanel"
                            ...
                            <div class="row">
                                <!--<div class="col-md-3">
                                    <div class="textLeft">
                                        <?php /*_e('Conheça as soluções da TIVIT por <strong>Serviços e Produtos.</strong>');*/ ?>
                                        <p><?php /*echo $por_servico_port; */ ?></p>
                                ...
                                <div class="col-md-12">
                                    ...
                                    // print_r($menus);
                                    echo '<div class="row row-cols-5 justify-content-between">';
                                    $ss = 0;
                                    foreach ($menus as $chave => $conteudo) {
                                        if ($ss > 2) {
                                            $mt5 = "";
                                        }
                                        echo '<div class="col-md-auto ' . $mt5 . '">';
