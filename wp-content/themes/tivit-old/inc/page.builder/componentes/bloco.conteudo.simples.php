...
function pb_bloco_conteudo_simples($obj_id,$obj = null,$block=0,$echo = true){		
	...
	if($echo){
		...
		echo "<section id=\"gd-el-simple-$block-$obj_id\" class=\"box-section height-$s_height  header-coutoman-$s_color_of_menu\" data-anijs=\"if: scroll, on: window, do: fadeInUp animated, before: scrollReveal\">";
