...
function pb_video_full($obj_id,$obj = null,$block=0,$echo = true){
	...
	$generate_element = '	            
        <!---- Video Full Module -->
        <section class="box-video-full header-coutoman-dark" id="gd-el-video-full-'.$block.'" style="'.$tb.'" data-anijs="if: scroll, on: window, do: fadeInUp animated, before: scrollReveal">
            <div class="video-wrapper">
