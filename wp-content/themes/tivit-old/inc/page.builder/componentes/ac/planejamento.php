...
function pb_ac_planejamento($obj_id, $obj = null, $block, $echo = true)
{
    ...
    <section class="container-fluid px-lg-0 card-only-text" style="background: ' . $s_color_background . ';" data-anijs="if: scroll, on: window, do: fadeInUp animated, before: scrollReveal">
        <div class="container">
            <div class="row row-cols-1 justify-content-center">
