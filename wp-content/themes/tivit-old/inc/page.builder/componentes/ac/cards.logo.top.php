...
function pb_ac_card_imagem_top($obj_id, $obj = null, $block, $echo = true)
{
    ...
    <section class="container-fluid px-lg-0 card-only-text cards-images-centred" id="{css_id}" data-anijs="if: scroll, on: window, do: fadeInUp animated, before: scrollReveal">
        <div class="container">
