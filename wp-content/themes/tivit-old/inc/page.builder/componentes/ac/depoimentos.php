...
function pb_ac_depoimentos($obj_id, $obj = null, $block, $echo = true)
{
    ...
    <style>
     ...
     <section class="container-fluid px-lg-0 box-feedback-cliente {classAlt}" id="box-f-client{id}" data-anijs="if: scroll, on: window, do: fadeInUp animated, before: scrollReveal">
        <div class="container">
            {title_container}
