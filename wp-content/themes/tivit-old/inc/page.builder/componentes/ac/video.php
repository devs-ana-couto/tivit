...
function pb_ac_video($obj_id, $obj = null, $block, $echo = true)
{
    ...
    $template = '
     ...
     <!---- AC: video Module -->
        ...
        <section class="container-fluid box-videos position-relative" id="{css_id_object}" style="background: white;" data-anijs="if: scroll, on: window, do: fadeInUp animated, before: scrollReveal">
