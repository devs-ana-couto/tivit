...
function pb_gallery($obj_id,$obj = null,$block=0,$echo = true){	
	...
	$generate_element = '	            
        <!---- Gallery Module -->
        <section class="box-gallery header-coutoman-dark" id="gd-el-gallery-'.$block.'" style="'.$tb.'" data-anijs="if: scroll, on: window, do: fadeInUp animated, before: scrollReveal">        
