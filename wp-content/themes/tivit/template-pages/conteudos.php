                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="navigation">
                                <button class="carousel-control-prev" type="button" data-bs-target="#hero"
                                        data-bs-slide="prev">
                                ...
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#content" data-bs-slide-to="0" class="active"
                                            aria-current="true" aria-label="Content 1"></button>
                                    <button type="button" data-bs-target="#content" data-bs-slide-to="1"
                                            aria-label="Content 2"></button>
                                    <button type="button" data-bs-target="#content" data-bs-slide-to="2"
                                            aria-label="Content 3"></button>
                                    <button type="button" data-bs-target="#content" data-bs-slide-to="3"
                                            aria-label="Content 4"></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                for ($i = 0; $i < 6; $i++) {
                    ...
                    <div class="col-12 col-md-4">
                        <div class="img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cases/cases/01.svg"
                                 alt="Depoimento">
                        </div>
                        <div class="autor-time">
                        ...
                        <div class="acessar">
                            <a href="#">acessar artigo <img
                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/a-tivit/arrow.svg"
                                        class="hide-desktop" alt="Saiba Mais"></a>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="slider-cases">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#cases" data-bs-slide-to="0" class="active"
                                            aria-current="true" aria-label="Cases 1">1
                                    </button>
                                    <button type="button" data-bs-target="#cases" data-bs-slide-to="1"
                                            aria-label="Cases 2">2
                                    </button>
                                    <button type="button" data-bs-target="#cases" data-bs-slide-to="2"
                                            aria-label="Cases 3">3
                                    </button>
                                    <button type="button" data-bs-target="#cases" data-bs-slide-to="3"
                                            aria-label="Cases 4">4
                                    </button>
                                </div>
                            </div>
                        </div>
